...
class NotesViewModelFactory(val context: Context,
                            val userDataStore: SharedPreferencesUserDataStore) : ViewModelProvider.Factory{
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(NotesSharedViewModel::class.java)) {
            ...
            val repository = NotesRepository(noteDao, apiService, userDataStore, context)
